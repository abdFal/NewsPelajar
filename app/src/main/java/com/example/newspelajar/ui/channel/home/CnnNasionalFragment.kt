...
class CnnNasionalFragment : Fragment(){
    ...
    private val cnnNewsNasionalViewModel: NewsViewModel by viewModels {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (cnnNewsNasionalViewModel.cnnNewsNasional.value == null){
            cnnNewsNasionalViewModel.getCnnNewsNasional()
        }
        cnnNewsNasionalViewModel.cnnNewsNasional.observe(viewLifecycleOwner){data ->
