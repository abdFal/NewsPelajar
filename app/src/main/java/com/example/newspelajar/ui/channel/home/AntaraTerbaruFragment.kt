...
class AntaraTerbaruFragment : Fragment() {
    ...
    private val antaraTerbaruViewModel: NewsViewModel by viewModels {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (antaraTerbaruViewModel.antaraNewsTerbaru.value == null){
            antaraTerbaruViewModel.getAntaraNewsTerbaru()
        }
        antaraTerbaruViewModel.antaraNewsTerbaru.observe(viewLifecycleOwner){data ->
